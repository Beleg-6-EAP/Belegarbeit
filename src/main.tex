...
oder einen unabhängigen Teil der Business Logik.

Der wesentliche Unterschied zur Service-oriented Architecture liegt in der Kapselung und Granularität der Services.
Die Services liegen nicht mehr gemeinsam in einer Anwendung, sondern sind eigenständig in eigenen Projekten abgekapselt.
Jeder Service hat seine eigene private Datenbank, die nicht für andere Services sichtbar ist\cite[2]{microservicesArchitecture}.
Außerdem besteht die Möglichkeit die Service-Komponenten mit unterschiedlichen Technologien zu entwickeln, da die Kommunikation über standardisierte Schnittstellen stattfindet.
...
Die Microservices Architektur löst viele der Probleme, die in klassischen monolithischen oder Service-oriented Architecture auftreten.
