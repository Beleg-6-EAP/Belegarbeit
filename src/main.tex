...
der Provider diese implementiert und die Registry jene persistiert \cite[3]{soa2}\cite[37]{soa4}.
...
Meist werden dafür zum Nachrichtenaustausch das Protokoll SOAP und die Schnittstellenbeschreibungssprache WSDL verwendet \cite[4]{soa2}.
