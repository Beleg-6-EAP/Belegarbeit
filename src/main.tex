...
Dieser kommuniziert dann wiederrum mit den relevanten Service-Komponenten, die dann die Anfrage verarbeiten und ein Resultat an das Gateway zurückgeben~\cite[30]{architecturePatterns}.
...
Der korrekte Entwurf der Architektur und die darin korrekt gewählte Granularität der Services ist entscheidend, um die Vorteile der Microservices Architecture voll auszuschöpfen und stellt hier die größte Herausforderung dar.
...
Auf der anderen Seite führt eine zu geringe Granularität dazu, dass die Anzahl der Services zu groß wird und das Orchestrieren dieser einen zu großen Overhead verursacht.
Komplexität und Wartungsaufwand steigen an und die Schwächen einer klassischen Service-oriented Architecture treten wieder auf~\cite[32]{architecturePatterns}.
...
%% Aber: Integrationstests anspruchsvoller, da viele Komoponenten zusammen deployt werden müssen
