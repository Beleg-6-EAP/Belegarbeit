...
EDA zeichnet sich durch die asynchrone Reaktion auf Ereignisse aus, wodurch die Anwendung sehr flexibel und skalierbar wird.
...
Als Architektur für besonders erweiterbare Anwendungen zeichnen sich die Microkernel-Architektur aus, die die Anwendung auf einen Kern mit wenig Funktionalität und Plugins mit Business-Logik auftrennt.
...
Auffallend ist zum einen, dass monolithische Anwendungen zwar die beste Time-To-Market haben, den anderen Architekturmustern jedoch in allen anderen Kategorien unterlegen.
Die Architekturen mit der besten Skalierbarkeit zeichnen sich durch die starke Isolation von Komponenten aus und sind hier Microservices, EDA und Cloud-Native Architekturen.
...
Moderne Architekturen, insbesondere Microservices, EDA und Cloud-Native Architekturen, können Software in kleinen Teilen ausliefern und so schneller auf Änderungen der Anforderungen reagieren.
...
Die Wahl der Architektur muss den spezifischen Anforderungen des Projekts angepasst sein und besteht meist aus einer Kombination mehrerer EA-Muster.
