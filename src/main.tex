...
Provider registrieren ihre Dienste in der Registry und Consumer können Dienste dynamisch zu Laufzeit entdecken. \cite[23 - 24]{soa4}.
In der Spezifikation der Dienste beschreibt wie ein Consumer mit dem Provider interagieren kann.
Hierbei werden Nachrichtenformate der Anfrage sowie der Antwort definiert.
Zusätzliche Informationen können ebenfalls in der Spezifikation enthalten sein, wie etwa die Bedingungen für die Nutzung des Dienstes. \cite[26]{soa4}
